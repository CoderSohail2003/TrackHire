...
export default function Profile({ userProfile, setUserProfile }) {
  // Local state for the form so it doesn't update the sidebar until we hit "Save"
    ...
    <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in duration-300">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex items-center gap-6">
        <img 
          src={profileIcon} 
          alt="Profile" 
          className="h-24 w-24 rounded-full bg-indigo-50 p-2 object-cover shadow-sm border border-indigo-100"
        />
        <div>
          ...
          <p className="text-gray-500 text-lg mt-1">
            {userProfile.title !== 'Unknown' ? userProfile.title : 'Setup your profile below'}
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  type="text" 
                  placeholder="e.g. Sohail Manzoor Khan" 
                  className="w-full pl-10 pr-4 py-2.5 border rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all"
                  value={formData.name}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  type="text" 
                  placeholder="e.g. MCA Student & Web Developer" 
                  className="w-full pl-10 pr-4 py-2.5 border rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all"
          ...
          <div className="pt-4 flex items-center justify-between border-t border-gray-100 mt-6">
            ...
            <button 
              type="submit" 
              className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 rounded-xl font-bold shadow-md hover:shadow-lg transition-all active:scale-95 flex items-center gap-2"
            >
              <Save size={18} />
              Save Profile
            </button>
