              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <input 
                      type="text" placeholder="e.g. Resume_v2.pdf" 
                      className="w-full pl-10 pr-4 py-2.5 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-400 outline-none transition-all disabled:bg-gray-100"
